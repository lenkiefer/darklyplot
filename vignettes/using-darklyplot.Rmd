...
In the example below we first filter `txhousing` to just the observations for Lubbock, Texas and try to plot sales with darklyplot.

```{r vignette-5,message=FALSE,warning=FALSE,out.width="50%",fig.width=12,fig.height=8,error=TRUE}
